...
$prefill_room_id = isset($_GET['room_id']) ? $_GET['room_id'] : '';
$prefill_total_amount = isset($_GET['total_amount']) ? $_GET['total_amount'] : '';
$prefill_description = isset($_GET['description']) ? $_GET['description'] : '';
                            ...
                            <div class="card-body">
                                ...
                                <select name="room_id" class="form-control" required>
                                    ...
                                    <?php while ($room = $room_result->fetch_assoc()) { ?>
                                        <option value="<?php echo $room['id']; ?>" <?= ($room['id'] == $prefill_room_id) ? 'selected' : '' ?>>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                <input type="number" name="total_amount" id="total_amount" step="0.01" required class="form-control"
                                   value="<?= htmlspecialchars($prefill_total_amount) ?>">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="description" required class="form-control" value="<?= htmlspecialchars($prefill_description) ?>">
                                </div>
                            </div>
                        </div>
                    </div>
