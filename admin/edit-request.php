<?php
    ...
    $query = "SELECT m.id, r.room_number, t.full_name, m.description, m.request_date, m.status 
    ...
    // Xử lý cập nhật trạng thái yêu cầu bảo trì
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Request updated successfully.'); window.location='manage-request.php';</script>";
        } else {
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <form method="POST">
                    ...
                    <?php	
                        $id=$_GET['id'];
						$ret="SELECT m.id, r.room_number, t.full_name, m.description, m.request_date, m.status 
                                FROM maintenance_requests m
                                JOIN rooms r ON m.room_id = r.id
                                JOIN tenants t ON m.tenant_id = t.tenant_id
                                WHERE m.id = ?";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Tenant</h4>
                                        <div class="form-group">
                                            <input type="text" name="full_name" value="<?php echo $row->full_name;?>" id="full_name" class="form-control" disabled>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Description</h4>
                                        <div class="form-group">
                                            <input type="text" name="description" value="<?php echo $row->description;?>" id="description" class="form-control" disabled>
                                        </div>
