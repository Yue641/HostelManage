                            ...
                            <hr>
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <a href="manage-bill.php?del=<?php echo $row->id;?>" title="Delete Record" onclick="return confirm("Do you want to delete");"><i class="icon-close" style="color:red;"></i></a>&nbsp;&nbsp;
                                        <a href="export/export_bill.php?id=<?php echo $row->id;?>" title="Print BIll"><i class="icon-printer" style="color:blue;"></i></a>
                                        </td>
                                        </tr>
                                            <?php
                                        $cnt=$cnt+1;
