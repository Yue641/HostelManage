...
<?php
    ...
    $query="UPDATE  tenants set full_name=?, phone=?, email=?, id_card_number=?, address=? where tenant_id=?";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('sssss',$full_name,$phone,$email,$id_card_number,$address);
    $stmt->execute();
            ...
            <div class="container-fluid">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <?php	
                        $aid=$_SESSION['tenant_id'];
                            $ret="select * from tenants where tenant_id=?";
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Full Name</h4>
                                        <div class="form-group">
                                            <input type="text" name="full_name" id="full_name" class="form-control" value="<?php echo $row->full_name;?>"   required="required">
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">ID Number</h4>
                                        <div class="form-group">
                                            <input type="text" name="id_card_number" id="id_card_number" class="form-control" value="<?php echo $row->id_card_number;?>" required="required">
                                        </div>
                                </div>
                            </div>
                        </div>
